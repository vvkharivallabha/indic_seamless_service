...
from app import TargetLanguage, SUPPORTED_LANGUAGES
...
def main():
    ...
    for enum_member in TargetLanguage:
        ...
        language_code = enum_member.value
        full_name = SUPPORTED_LANGUAGES.get(language_code, "Unknown")
        
        print(f"   {enum_name:<25} -> {language_code} ({full_name})")
        languages_shown += 1
