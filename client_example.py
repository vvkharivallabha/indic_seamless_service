...
class IndicSeamlessSTTClient:
    ...
    def speech_to_text(self, audio_file: str, source_lang: str = "eng") -> Dict[str, Any]:
        """
...
def main():
    ...
    try:
        ...
        print("   You can test with any audio file in supported formats (wav, mp3, flac, m4a, ogg)")
        ...
        for test_file in test_files:
            if os.path.exists(test_file):
                ...
                try:
                    result = client.speech_to_text(test_file, "eng")
