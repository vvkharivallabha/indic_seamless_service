...
class Settings:
    ...
    def __init__(self):
        ...
        self.description: str = "A production-ready REST API service for speech-to-text conversion using the ai4bharat/indic-seamless model"
        ...
        self.trust_remote_code: bool = os.getenv("TRUST_REMOTE_CODE", "true").lower() == "true"
        
        # Audio Processing Configuration
        self.allowed_extensions: Set[str] = {'wav', 'mp3', 'flac', 'm4a', 'ogg'}
        self.max_content_length: int = int(os.getenv("MAX_CONTENT_LENGTH", str(50 * 1024 * 1024)))  # 50MB
